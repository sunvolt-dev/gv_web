 ...
 * 상품 카드 partial
 * 입력: $p (products 한 행)
 * 사용: <?php include __DIR__ . '/_product_card.php'; ?>
 */
...
<a href="<?= h(url('/shop/item.php', ['it_id' => $p['it_id']])) ?>"
  ...
  <div class="relative aspect-square bg-gray-50 overflow-hidden">
    ...
    <div class="absolute top-2 left-2 flex flex-col gap-1">
      <?php if ($p['it_best']): ?>
      <span class="px-2 py-0.5 rounded text-[10px] font-bold badge-best">BEST</span>
      <?php endif; ?>
      <?php if ($p['it_new']): ?>
      <span class="px-2 py-0.5 rounded text-[10px] font-bold badge-new">NEW</span>
      <?php endif; ?>
    </div>
  ...
  <div class="p-3 md:p-4">
    ...
    <?php endif; ?>
    <div class="font-semibold text-sm md:text-[15px] text-gray-900
                line-clamp-2 leading-snug min-h-[2.6em]
